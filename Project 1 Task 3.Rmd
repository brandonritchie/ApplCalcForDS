...
This first model is very simple. It is $f_0(t;a_0)=a_0$. We must fit a line that will best represent the data. For this model I set $a_0 = 101$. This suggests that no matter what the hour of the lightbulbs lifetime, the intensity will be 101%.
